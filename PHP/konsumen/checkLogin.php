...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $query = "SELECT * FROM tb_user INNER JOIN tb_konsumen ON tb_user.id_user = tb_konsumen.id_konsumen WHERE username='$username' AND password='$password' AND role='konsumen'";
