...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $query = "SELECT * FROM tb_user INNER JOIN tb_penjual ON tb_user.id_user = tb_penjual.id_penjual WHERE username='$username' AND password='$password' AND role='kantin'";
