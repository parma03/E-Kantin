...
import com.example.e_kantin.adapter.PenjualHistoriPesananAdapter;
import com.example.e_kantin.databinding.FragmentKonsumenHistoriBinding;
import com.example.e_kantin.databinding.FragmentPenjualHistoriBinding;
...
public class PenjualHistoriFragment extends Fragment {
    private FragmentPenjualHistoriBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPenjualHistoriBinding.inflate(inflater, container, false);
        ...
        binding.btnCetak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(requireContext(), PrintHistoriPesananActivity.class);
    ...
    private void dataHistori() {
        dialog.show();
        AndroidNetworking.get(ApiServer.site_url_penjual + "getHistori.php?id_penjual="+prefManager.getId())
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (response.getString("code").equalsIgnoreCase("1")) {
                                ...
                                PenjualHistoriPesananAdapter adapter = new PenjualHistoriPesananAdapter(requireContext(), checkoutModelList);
    ...
    public void hapusData(String id_penjual) {
        AndroidNetworking.post(ApiServer.site_url_penjual + "deleteHistori.php")
