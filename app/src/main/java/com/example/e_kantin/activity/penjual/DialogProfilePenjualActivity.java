...
public class DialogProfilePenjualActivity extends AppCompatDialogFragment {
    ...
    private static final String URL_UPDATE_PROFILE =
            ApiServer.site_url_penjual + "updateProfile.php";
    private static final String URL_DELETE_GAMBAR =
            ApiServer.site_url_penjual + "deleteFotoProfile.php";
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_dialog_profile_penjual, null);
        ...
        editNama.setText(prefManager.getNama());
        editNohp.setText(prefManager.getNohp());
        ...
        if (prefManager.getImg() != null && !prefManager.getImg().equals("null")) {
            ...
            editImgProfile.setImageResource(R.drawable.penjual);
        }
    ...
    private void updateMenu(Uri newImageUri) {
        String updateNama = editNama.getText().toString();
        String updateNohp = editNohp.getText().toString();
        ...
        AndroidNetworking.upload(URL_UPDATE_PROFILE)
                ...
                .addMultipartParameter("nama", updateNama)
                .addMultipartParameter("nohp", updateNohp)
