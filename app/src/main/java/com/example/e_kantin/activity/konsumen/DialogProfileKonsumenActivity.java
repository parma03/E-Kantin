...
public class DialogProfileKonsumenActivity extends AppCompatDialogFragment {
    ...
    private static final String URL_UPDATE_PROFILE =
            ApiServer.site_url_konsumen + "updateProfile.php";
    private static final String URL_DELETE_GAMBAR =
            ApiServer.site_url_konsumen + "deleteFotoProfile.php";
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_dialog_profile_konsumen, null);
        ...
        if (prefManager.getImg() != null && !prefManager.getImg().equals("null")) {
            ...
            editImgProfile.setImageResource(R.drawable.man);
        }
